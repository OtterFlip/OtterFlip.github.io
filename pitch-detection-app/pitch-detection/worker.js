  ...
  _createClass(AutocorrelationDetector, [{
    ...
    */
    function get_pitch(signal, sample_rate, power_threshold, clarity_threshold, pitch) {
      ...
      wasm.autocorrelationdetector_get_pitch(this.ptr, ptr0, len0, sample_rate, power_threshold, clarity_threshold, ptr1, len1, addHeapObject(pitch));
    }
  }], [{
    key: "__wrap",
  ...
  _createClass(McLeodDetector, [{
    ...
    */
    function get_pitch(signal, sample_rate, power_threshold, clarity_threshold, pitch) {
      ...
      var ptr1 = passArrayF32ToWasm0(pitch, wasm.__wbindgen_malloc);
      var len1 = WASM_VECTOR_LEN;
      wasm.mcleoddetector_get_pitch(this.ptr, ptr0, len0, sample_rate, power_threshold, clarity_threshold, ptr1, len1, addHeapObject(pitch));
    }
  }], [{
    key: "__wrap",
    value: function __wrap(ptr) {
